...
![Tech Stack](https://skillicons.dev/icons?i=flutter,dart,firebase,supabase,js,ts,nestjs,mongodb,postgres,npm,cs,cpp,python,html,css,git,figma,java,vscode,discord)
